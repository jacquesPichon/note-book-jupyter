...
message.pack()
boutonexemple = tk.Button(fen, text = 'Exemple', command = changetext(mes))
...
nmystere = tk.StringVar() # <<<=====
label = tk.Label(fen, text="Salut", fg="blue", bg="yellow", textvariable=nmystere) # <<<<==
